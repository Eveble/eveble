...
export const HookableTrait = trait(
  (base) =>
    class extends base implements types.Hookable {
      /**
       ...
       * import {HookableTrait} from 'eveble'
       *
       * class Document extends HookableTrait {
       *   content: string;
       *
       *   version: number;
       *
       ...
       * @example
       *```ts
       * class MyClass extends HookableTrait {}
       *
      ...
      public getHooks(action: string): types.hooks.Mappings {
        const matcher = (proto: types.Prototype): boolean =>
          ...
          (proto.constructor as any) !== HookableTrait;
      ...
      public getActions(): types.hooks.Actions {
        ...
        const actions: types.hooks.Actions = merge(
          parentActions,
          childActions,
          {
            isMergeableObject: isPlainObject,
