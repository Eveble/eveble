---
id: "invalidlisterror"
title: "InvalidListError"
sidebar_label: "InvalidListError"
---
...
* [constructor](invalidlisterror.md#constructor)

### Properties

* [code](invalidlisterror.md#optional-code)
* [message](invalidlisterror.md#message)
* [name](invalidlisterror.md#name)
* [schemaVersion](invalidlisterror.md#optional-schemaversion)
* [stack](invalidlisterror.md#optional-stack)

### Methods

* [equals](invalidlisterror.md#equals)
* [fillErrorProps](invalidlisterror.md#fillerrorprops)
* [getActions](invalidlisterror.md#getactions)
* [getHook](invalidlisterror.md#gethook)
* [getHookOrThrow](invalidlisterror.md#gethookorthrow)
* [getHooks](invalidlisterror.md#gethooks)
* [getLegacyTransformer](invalidlisterror.md#getlegacytransformer)
* [getLegacyTransformers](invalidlisterror.md#getlegacytransformers)
* [getPropTypes](invalidlisterror.md#getproptypes)
* [getPropertyInitializers](invalidlisterror.md#getpropertyinitializers)
* [getSchemaVersion](invalidlisterror.md#getschemaversion)
* [getTypeName](invalidlisterror.md#gettypename)
* [hasAction](invalidlisterror.md#hasaction)
* [hasHook](invalidlisterror.md#hashook)
* [hasLegacyTransformer](invalidlisterror.md#haslegacytransformer)
* [overrideHook](invalidlisterror.md#overridehook)
* [overrideLegacyTransformer](invalidlisterror.md#overridelegacytransformer)
* [registerHook](invalidlisterror.md#registerhook)
* [registerLegacyTransformer](invalidlisterror.md#registerlegacytransformer)
* [removeHook](invalidlisterror.md#removehook)
* [toJSONValue](invalidlisterror.md#tojsonvalue)
* [toPlainObject](invalidlisterror.md#toplainobject)
* [toString](invalidlisterror.md#tostring)
* [transformLegacyProps](invalidlisterror.md#transformlegacyprops)
* [typeName](invalidlisterror.md#typename)
* [validateProps](invalidlisterror.md#validateprops)
* [getPropTypes](invalidlisterror.md#static-getproptypes)
* [getPropertyInitializers](invalidlisterror.md#static-getpropertyinitializers)
* [getTypeName](invalidlisterror.md#static-gettypename)
* [toString](invalidlisterror.md#static-tostring)
* [typeName](invalidlisterror.md#static-typename)

## Constructors

###  constructor

\+ **new InvalidListError**(`sourceName`: string, `listName`: string): *[InvalidListError](invalidlisterror.md)*
...
**Returns:** *[InvalidListError](invalidlisterror.md)*
