---
id: "tasklistassigned"
title: "TaskListAssigned"
sidebar_label: "TaskListAssigned"
---
...
* [constructor](tasklistassigned.md#constructor)

### Properties

* [employeeId](tasklistassigned.md#employeeid)
* [metadata](tasklistassigned.md#optional-metadata)
* [schemaVersion](tasklistassigned.md#optional-schemaversion)
* [sourceId](tasklistassigned.md#sourceid)
* [timestamp](tasklistassigned.md#optional-timestamp)
* [version](tasklistassigned.md#optional-version)

### Methods

* [assignMetadata](tasklistassigned.md#assignmetadata)
* [equals](tasklistassigned.md#equals)
* [getActions](tasklistassigned.md#getactions)
* [getCorrelationId](tasklistassigned.md#getcorrelationid)
* [getHook](tasklistassigned.md#gethook)
* [getHookOrThrow](tasklistassigned.md#gethookorthrow)
* [getHooks](tasklistassigned.md#gethooks)
* [getId](tasklistassigned.md#getid)
* [getLegacyTransformer](tasklistassigned.md#getlegacytransformer)
* [getLegacyTransformers](tasklistassigned.md#getlegacytransformers)
* [getMetadata](tasklistassigned.md#getmetadata)
* [getPropTypes](tasklistassigned.md#getproptypes)
* [getPropertyInitializers](tasklistassigned.md#getpropertyinitializers)
* [getSchemaVersion](tasklistassigned.md#getschemaversion)
* [getTimestamp](tasklistassigned.md#gettimestamp)
* [getTypeName](tasklistassigned.md#gettypename)
* [hasAction](tasklistassigned.md#hasaction)
* [hasCorrelationId](tasklistassigned.md#hascorrelationid)
* [hasHook](tasklistassigned.md#hashook)
* [hasLegacyTransformer](tasklistassigned.md#haslegacytransformer)
* [hasMetadata](tasklistassigned.md#hasmetadata)
* [in](tasklistassigned.md#in)
* [overrideHook](tasklistassigned.md#overridehook)
* [overrideLegacyTransformer](tasklistassigned.md#overridelegacytransformer)
* [processSerializableList](tasklistassigned.md#processserializablelist)
* [registerHook](tasklistassigned.md#registerhook)
* [registerLegacyTransformer](tasklistassigned.md#registerlegacytransformer)
* [removeHook](tasklistassigned.md#removehook)
* [setCorrelationId](tasklistassigned.md#setcorrelationid)
* [toJSONValue](tasklistassigned.md#tojsonvalue)
* [toPlainObject](tasklistassigned.md#toplainobject)
* [toString](tasklistassigned.md#tostring)
* [transformLegacyProps](tasklistassigned.md#transformlegacyprops)
* [typeName](tasklistassigned.md#typename)
* [validateProps](tasklistassigned.md#validateprops)
* [disableSerializableLists](tasklistassigned.md#static-disableserializablelists)
* [enableSerializableLists](tasklistassigned.md#static-enableserializablelists)
* [from](tasklistassigned.md#static-from)
* [getPropTypes](tasklistassigned.md#static-getproptypes)
* [getPropertyInitializers](tasklistassigned.md#static-getpropertyinitializers)
* [getTypeName](tasklistassigned.md#static-gettypename)
* [toString](tasklistassigned.md#static-tostring)
* [typeName](tasklistassigned.md#static-typename)

## Constructors

###  constructor

\+ **new TaskListAssigned**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[TaskListAssigned](tasklistassigned.md)› & object): *[TaskListAssigned](tasklistassigned.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[TaskListAssigned](tasklistassigned.md)› & object | Properties matching generic `T` with `sourceId` as `Guid|string` and optional `version` as `number`.  |

**Returns:** *[TaskListAssigned](tasklistassigned.md)*
