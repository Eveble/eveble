...
title: "ChangeTaskPriority"
sidebar_label: "ChangeTaskPriority"
---
...
* [constructor](changetaskpriority.md#constructor)

### Properties

* [id](changetaskpriority.md#id)
* [metadata](changetaskpriority.md#optional-metadata)
* [priority](changetaskpriority.md#priority)
* [schemaVersion](changetaskpriority.md#optional-schemaversion)
* [targetId](changetaskpriority.md#targetid)
* [timestamp](changetaskpriority.md#optional-timestamp)

### Methods

* [assignMetadata](changetaskpriority.md#assignmetadata)
* [equals](changetaskpriority.md#equals)
* [getActions](changetaskpriority.md#getactions)
* [getAssignment](changetaskpriority.md#getassignment)
* [getCorrelationId](changetaskpriority.md#getcorrelationid)
* [getHook](changetaskpriority.md#gethook)
* [getHookOrThrow](changetaskpriority.md#gethookorthrow)
* [getHooks](changetaskpriority.md#gethooks)
* [getId](changetaskpriority.md#getid)
* [getLegacyTransformer](changetaskpriority.md#getlegacytransformer)
* [getLegacyTransformers](changetaskpriority.md#getlegacytransformers)
* [getMetadata](changetaskpriority.md#getmetadata)
* [getPropTypes](changetaskpriority.md#getproptypes)
* [getPropertyInitializers](changetaskpriority.md#getpropertyinitializers)
* [getSchemaVersion](changetaskpriority.md#getschemaversion)
* [getTimestamp](changetaskpriority.md#gettimestamp)
* [getTypeName](changetaskpriority.md#gettypename)
* [hasAction](changetaskpriority.md#hasaction)
* [hasCorrelationId](changetaskpriority.md#hascorrelationid)
* [hasHook](changetaskpriority.md#hashook)
* [hasLegacyTransformer](changetaskpriority.md#haslegacytransformer)
* [hasMetadata](changetaskpriority.md#hasmetadata)
* [in](changetaskpriority.md#in)
* [isDeliverable](changetaskpriority.md#isdeliverable)
* [isScheduled](changetaskpriority.md#isscheduled)
* [overrideHook](changetaskpriority.md#overridehook)
* [overrideLegacyTransformer](changetaskpriority.md#overridelegacytransformer)
* [processSerializableList](changetaskpriority.md#processserializablelist)
* [registerHook](changetaskpriority.md#registerhook)
* [registerLegacyTransformer](changetaskpriority.md#registerlegacytransformer)
* [removeHook](changetaskpriority.md#removehook)
* [schedule](changetaskpriority.md#schedule)
* [setCorrelationId](changetaskpriority.md#setcorrelationid)
* [toJSONValue](changetaskpriority.md#tojsonvalue)
* [toPlainObject](changetaskpriority.md#toplainobject)
* [toString](changetaskpriority.md#tostring)
* [transformLegacyProps](changetaskpriority.md#transformlegacyprops)
* [typeName](changetaskpriority.md#typename)
* [validateProps](changetaskpriority.md#validateprops)
* [disableSerializableLists](changetaskpriority.md#static-disableserializablelists)
* [enableSerializableLists](changetaskpriority.md#static-enableserializablelists)
* [from](changetaskpriority.md#static-from)
* [getPropTypes](changetaskpriority.md#static-getproptypes)
* [getPropertyInitializers](changetaskpriority.md#static-getpropertyinitializers)
* [getTypeName](changetaskpriority.md#static-gettypename)
* [toString](changetaskpriority.md#static-tostring)
* [typeName](changetaskpriority.md#static-typename)

## Constructors

###  constructor

\+ **new ChangeTaskPriority**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[ChangeTaskPriority](changetaskpriority.md)› & object): *[ChangeTaskPriority](changetaskpriority.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[ChangeTaskPriority](changetaskpriority.md)› & object | Properties matching generic `T` with `targetId` as `Guid|string`.  |

**Returns:** *[ChangeTaskPriority](changetaskpriority.md)*
