---
id: "assigntasklisttoemployee"
title: "AssignTaskListToEmployee"
sidebar_label: "AssignTaskListToEmployee"
---
...
* [constructor](assigntasklisttoemployee.md#constructor)

### Properties

* [metadata](assigntasklisttoemployee.md#optional-metadata)
* [schemaVersion](assigntasklisttoemployee.md#optional-schemaversion)
* [targetId](assigntasklisttoemployee.md#targetid)
* [taskListId](assigntasklisttoemployee.md#tasklistid)
* [timestamp](assigntasklisttoemployee.md#optional-timestamp)

### Methods

* [assignMetadata](assigntasklisttoemployee.md#assignmetadata)
* [equals](assigntasklisttoemployee.md#equals)
* [getActions](assigntasklisttoemployee.md#getactions)
* [getAssignment](assigntasklisttoemployee.md#getassignment)
* [getCorrelationId](assigntasklisttoemployee.md#getcorrelationid)
* [getHook](assigntasklisttoemployee.md#gethook)
* [getHookOrThrow](assigntasklisttoemployee.md#gethookorthrow)
* [getHooks](assigntasklisttoemployee.md#gethooks)
* [getId](assigntasklisttoemployee.md#getid)
* [getLegacyTransformer](assigntasklisttoemployee.md#getlegacytransformer)
* [getLegacyTransformers](assigntasklisttoemployee.md#getlegacytransformers)
* [getMetadata](assigntasklisttoemployee.md#getmetadata)
* [getPropTypes](assigntasklisttoemployee.md#getproptypes)
* [getPropertyInitializers](assigntasklisttoemployee.md#getpropertyinitializers)
* [getSchemaVersion](assigntasklisttoemployee.md#getschemaversion)
* [getTimestamp](assigntasklisttoemployee.md#gettimestamp)
* [getTypeName](assigntasklisttoemployee.md#gettypename)
* [hasAction](assigntasklisttoemployee.md#hasaction)
* [hasCorrelationId](assigntasklisttoemployee.md#hascorrelationid)
* [hasHook](assigntasklisttoemployee.md#hashook)
* [hasLegacyTransformer](assigntasklisttoemployee.md#haslegacytransformer)
* [hasMetadata](assigntasklisttoemployee.md#hasmetadata)
* [in](assigntasklisttoemployee.md#in)
* [isDeliverable](assigntasklisttoemployee.md#isdeliverable)
* [isScheduled](assigntasklisttoemployee.md#isscheduled)
* [overrideHook](assigntasklisttoemployee.md#overridehook)
* [overrideLegacyTransformer](assigntasklisttoemployee.md#overridelegacytransformer)
* [processSerializableList](assigntasklisttoemployee.md#processserializablelist)
* [registerHook](assigntasklisttoemployee.md#registerhook)
* [registerLegacyTransformer](assigntasklisttoemployee.md#registerlegacytransformer)
* [removeHook](assigntasklisttoemployee.md#removehook)
* [schedule](assigntasklisttoemployee.md#schedule)
* [setCorrelationId](assigntasklisttoemployee.md#setcorrelationid)
* [toJSONValue](assigntasklisttoemployee.md#tojsonvalue)
* [toPlainObject](assigntasklisttoemployee.md#toplainobject)
* [toString](assigntasklisttoemployee.md#tostring)
* [transformLegacyProps](assigntasklisttoemployee.md#transformlegacyprops)
* [typeName](assigntasklisttoemployee.md#typename)
* [validateProps](assigntasklisttoemployee.md#validateprops)
* [disableSerializableLists](assigntasklisttoemployee.md#static-disableserializablelists)
* [enableSerializableLists](assigntasklisttoemployee.md#static-enableserializablelists)
* [from](assigntasklisttoemployee.md#static-from)
* [getPropTypes](assigntasklisttoemployee.md#static-getproptypes)
* [getPropertyInitializers](assigntasklisttoemployee.md#static-getpropertyinitializers)
* [getTypeName](assigntasklisttoemployee.md#static-gettypename)
* [toString](assigntasklisttoemployee.md#static-tostring)
* [typeName](assigntasklisttoemployee.md#static-typename)

## Constructors

###  constructor

\+ **new AssignTaskListToEmployee**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[AssignTaskListToEmployee](assigntasklisttoemployee.md)› & object): *[AssignTaskListToEmployee](assigntasklisttoemployee.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[AssignTaskListToEmployee](assigntasklisttoemployee.md)› & object | Properties matching generic `T` with `targetId` as `Guid|string`.  |

**Returns:** *[AssignTaskListToEmployee](assigntasklisttoemployee.md)*
