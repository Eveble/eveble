...
* [constructor](starttask.md#constructor)

### Properties

* [id](starttask.md#id)
* [metadata](starttask.md#optional-metadata)
* [schemaVersion](starttask.md#optional-schemaversion)
* [targetId](starttask.md#targetid)
* [timestamp](starttask.md#optional-timestamp)

### Methods

* [assignMetadata](starttask.md#assignmetadata)
* [equals](starttask.md#equals)
* [getActions](starttask.md#getactions)
* [getAssignment](starttask.md#getassignment)
* [getCorrelationId](starttask.md#getcorrelationid)
* [getHook](starttask.md#gethook)
* [getHookOrThrow](starttask.md#gethookorthrow)
* [getHooks](starttask.md#gethooks)
* [getId](starttask.md#getid)
* [getLegacyTransformer](starttask.md#getlegacytransformer)
* [getLegacyTransformers](starttask.md#getlegacytransformers)
* [getMetadata](starttask.md#getmetadata)
* [getPropTypes](starttask.md#getproptypes)
* [getPropertyInitializers](starttask.md#getpropertyinitializers)
* [getSchemaVersion](starttask.md#getschemaversion)
* [getTimestamp](starttask.md#gettimestamp)
* [getTypeName](starttask.md#gettypename)
* [hasAction](starttask.md#hasaction)
* [hasCorrelationId](starttask.md#hascorrelationid)
* [hasHook](starttask.md#hashook)
* [hasLegacyTransformer](starttask.md#haslegacytransformer)
* [hasMetadata](starttask.md#hasmetadata)
* [in](starttask.md#in)
* [isDeliverable](starttask.md#isdeliverable)
* [isScheduled](starttask.md#isscheduled)
* [overrideHook](starttask.md#overridehook)
* [overrideLegacyTransformer](starttask.md#overridelegacytransformer)
* [processSerializableList](starttask.md#processserializablelist)
* [registerHook](starttask.md#registerhook)
* [registerLegacyTransformer](starttask.md#registerlegacytransformer)
* [removeHook](starttask.md#removehook)
* [schedule](starttask.md#schedule)
* [setCorrelationId](starttask.md#setcorrelationid)
* [toJSONValue](starttask.md#tojsonvalue)
* [toPlainObject](starttask.md#toplainobject)
* [toString](starttask.md#tostring)
* [transformLegacyProps](starttask.md#transformlegacyprops)
* [typeName](starttask.md#typename)
* [validateProps](starttask.md#validateprops)
* [disableSerializableLists](starttask.md#static-disableserializablelists)
* [enableSerializableLists](starttask.md#static-enableserializablelists)
* [from](starttask.md#static-from)
* [getPropTypes](starttask.md#static-getproptypes)
* [getPropertyInitializers](starttask.md#static-getpropertyinitializers)
* [getTypeName](starttask.md#static-gettypename)
* [toString](starttask.md#static-tostring)
* [typeName](starttask.md#static-typename)

## Constructors

###  constructor

\+ **new StartTask**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[StartTask](starttask.md)› & object): *[StartTask](starttask.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[StartTask](starttask.md)› & object | Properties matching generic `T` with `targetId` as `Guid|string`.  |

**Returns:** *[StartTask](starttask.md)*
