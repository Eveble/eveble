...
* DomainError
  ...
  ↳ [IdentifiableAlreadyExistsError](identifiablealreadyexistserror.md)

  ↳ [ElementAlreadyExistsError](elementalreadyexistserror.md)

  ↳ [ElementNotFoundError](elementnotfounderror.md)

  ↳ [InvalidListError](invalidlisterror.md)
...
* [constructor](listerror.md#constructor)

### Properties

* [code](listerror.md#optional-code)
* [message](listerror.md#message)
* [name](listerror.md#name)
* [schemaVersion](listerror.md#optional-schemaversion)
* [stack](listerror.md#optional-stack)

### Methods

* [equals](listerror.md#equals)
* [fillErrorProps](listerror.md#fillerrorprops)
* [getActions](listerror.md#getactions)
* [getHook](listerror.md#gethook)
* [getHookOrThrow](listerror.md#gethookorthrow)
* [getHooks](listerror.md#gethooks)
* [getLegacyTransformer](listerror.md#getlegacytransformer)
* [getLegacyTransformers](listerror.md#getlegacytransformers)
* [getPropTypes](listerror.md#getproptypes)
* [getPropertyInitializers](listerror.md#getpropertyinitializers)
* [getSchemaVersion](listerror.md#getschemaversion)
* [getTypeName](listerror.md#gettypename)
* [hasAction](listerror.md#hasaction)
* [hasHook](listerror.md#hashook)
* [hasLegacyTransformer](listerror.md#haslegacytransformer)
* [overrideHook](listerror.md#overridehook)
* [overrideLegacyTransformer](listerror.md#overridelegacytransformer)
* [registerHook](listerror.md#registerhook)
* [registerLegacyTransformer](listerror.md#registerlegacytransformer)
* [removeHook](listerror.md#removehook)
* [toJSONValue](listerror.md#tojsonvalue)
* [toPlainObject](listerror.md#toplainobject)
* [toString](listerror.md#tostring)
* [transformLegacyProps](listerror.md#transformlegacyprops)
* [typeName](listerror.md#typename)
* [validateProps](listerror.md#validateprops)
* [getPropTypes](listerror.md#static-getproptypes)
* [getPropertyInitializers](listerror.md#static-getpropertyinitializers)
* [getTypeName](listerror.md#static-gettypename)
* [toString](listerror.md#static-tostring)
* [typeName](listerror.md#static-typename)

## Constructors

###  constructor

\+ **new ListError**(`propsOrMessage?`: [Props](../modules/types.md#props) | string): *[ListError](listerror.md)*
...
**Returns:** *[ListError](listerror.md)*
