...
\+ **new TaskHold**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[TaskHold](taskhold.md)› & object): *[TaskHold](taskhold.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[TaskHold](taskhold.md)› & object | Properties matching generic `T` with `sourceId` as `Guid|string` and optional `version` as `number`.  |
