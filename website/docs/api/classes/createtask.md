...
* [constructor](createtask.md#constructor)

### Properties

* [id](createtask.md#id)
* [metadata](createtask.md#optional-metadata)
* [name](createtask.md#name)
* [priority](createtask.md#priority)
* [schemaVersion](createtask.md#optional-schemaversion)
* [targetId](createtask.md#targetid)
* [timestamp](createtask.md#optional-timestamp)

### Methods

* [assignMetadata](createtask.md#assignmetadata)
* [equals](createtask.md#equals)
* [getActions](createtask.md#getactions)
* [getAssignment](createtask.md#getassignment)
* [getCorrelationId](createtask.md#getcorrelationid)
* [getHook](createtask.md#gethook)
* [getHookOrThrow](createtask.md#gethookorthrow)
* [getHooks](createtask.md#gethooks)
* [getId](createtask.md#getid)
* [getLegacyTransformer](createtask.md#getlegacytransformer)
* [getLegacyTransformers](createtask.md#getlegacytransformers)
* [getMetadata](createtask.md#getmetadata)
* [getPropTypes](createtask.md#getproptypes)
* [getPropertyInitializers](createtask.md#getpropertyinitializers)
* [getSchemaVersion](createtask.md#getschemaversion)
* [getTimestamp](createtask.md#gettimestamp)
* [getTypeName](createtask.md#gettypename)
* [hasAction](createtask.md#hasaction)
* [hasCorrelationId](createtask.md#hascorrelationid)
* [hasHook](createtask.md#hashook)
* [hasLegacyTransformer](createtask.md#haslegacytransformer)
* [hasMetadata](createtask.md#hasmetadata)
* [in](createtask.md#in)
* [isDeliverable](createtask.md#isdeliverable)
* [isScheduled](createtask.md#isscheduled)
* [overrideHook](createtask.md#overridehook)
* [overrideLegacyTransformer](createtask.md#overridelegacytransformer)
* [processSerializableList](createtask.md#processserializablelist)
* [registerHook](createtask.md#registerhook)
* [registerLegacyTransformer](createtask.md#registerlegacytransformer)
* [removeHook](createtask.md#removehook)
* [schedule](createtask.md#schedule)
* [setCorrelationId](createtask.md#setcorrelationid)
* [toJSONValue](createtask.md#tojsonvalue)
* [toPlainObject](createtask.md#toplainobject)
* [toString](createtask.md#tostring)
* [transformLegacyProps](createtask.md#transformlegacyprops)
* [typeName](createtask.md#typename)
* [validateProps](createtask.md#validateprops)
* [disableSerializableLists](createtask.md#static-disableserializablelists)
* [enableSerializableLists](createtask.md#static-enableserializablelists)
* [from](createtask.md#static-from)
* [getPropTypes](createtask.md#static-getproptypes)
* [getPropertyInitializers](createtask.md#static-getpropertyinitializers)
* [getTypeName](createtask.md#static-gettypename)
* [toString](createtask.md#static-tostring)
* [typeName](createtask.md#static-typename)

## Constructors

###  constructor

\+ **new CreateTask**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[CreateTask](createtask.md)› & object): *[CreateTask](createtask.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[CreateTask](createtask.md)› & object | Properties matching generic `T` with `targetId` as `Guid|string`.  |

**Returns:** *[CreateTask](createtask.md)*
