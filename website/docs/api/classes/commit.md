...
* [constructor](commit.md#constructor)

### Properties

* [commands](commit.md#commands)
* [eventSourceableType](commit.md#eventsourceabletype)
* [events](commit.md#events)
* [id](commit.md#id)
* [insertedAt](commit.md#insertedat)
* [receivers](commit.md#receivers)
* [schemaVersion](commit.md#optional-schemaversion)
* [sentBy](commit.md#sentby)
* [sourceId](commit.md#sourceid)
* [version](commit.md#version)

### Methods

* [addReceiver](commit.md#addreceiver)
* [equals](commit.md#equals)
* [getActions](commit.md#getactions)
* [getCommandTypeNames](commit.md#getcommandtypenames)
* [getEventTypeNames](commit.md#geteventtypenames)
* [getHook](commit.md#gethook)
* [getHookOrThrow](commit.md#gethookorthrow)
* [getHooks](commit.md#gethooks)
* [getLegacyTransformer](commit.md#getlegacytransformer)
* [getLegacyTransformers](commit.md#getlegacytransformers)
* [getPropTypes](commit.md#getproptypes)
* [getPropertyInitializers](commit.md#getpropertyinitializers)
* [getReceiver](commit.md#getreceiver)
* [getSchemaVersion](commit.md#getschemaversion)
* [getTypeName](commit.md#gettypename)
* [hasAction](commit.md#hasaction)
* [hasHook](commit.md#hashook)
* [hasLegacyTransformer](commit.md#haslegacytransformer)
* [in](commit.md#in)
* [overrideHook](commit.md#overridehook)
* [overrideLegacyTransformer](commit.md#overridelegacytransformer)
* [processSerializableList](commit.md#processserializablelist)
* [registerHook](commit.md#registerhook)
* [registerLegacyTransformer](commit.md#registerlegacytransformer)
* [removeHook](commit.md#removehook)
* [toJSONValue](commit.md#tojsonvalue)
* [toPlainObject](commit.md#toplainobject)
* [toString](commit.md#tostring)
* [transformLegacyProps](commit.md#transformlegacyprops)
* [typeName](commit.md#typename)
* [validateProps](commit.md#validateprops)
* [disableSerializableLists](commit.md#static-disableserializablelists)
* [enableSerializableLists](commit.md#static-enableserializablelists)
* [from](commit.md#static-from)
* [getPropTypes](commit.md#static-getproptypes)
* [getPropertyInitializers](commit.md#static-getpropertyinitializers)
* [getTypeName](commit.md#static-gettypename)
* [toString](commit.md#static-tostring)
* [typeName](commit.md#static-typename)

## Constructors

###  constructor

\+ **new Commit**(`props?`: [Props](../modules/types.md#props)): *[Commit](commit.md)*
...
*Implementation of [Commit](../interfaces/types.commit.md).[commands](../interfaces/types.commit.md#commands)*
...
*Implementation of [Commit](../interfaces/types.commit.md).[eventSourceableType](../interfaces/types.commit.md#eventsourceabletype)*
...
*Implementation of [Commit](../interfaces/types.commit.md).[events](../interfaces/types.commit.md#events)*
...
*Implementation of [Commit](../interfaces/types.commit.md).[id](../interfaces/types.commit.md#id)*
...
*Implementation of [Commit](../interfaces/types.commit.md).[insertedAt](../interfaces/types.commit.md#insertedat)*
...
*Implementation of [Commit](../interfaces/types.commit.md).[receivers](../interfaces/types.commit.md#receivers)*
...
*Implementation of [Commit](../interfaces/types.commit.md).[sentBy](../interfaces/types.commit.md#sentby)*
...
*Implementation of [Commit](../interfaces/types.commit.md).[sourceId](../interfaces/types.commit.md#sourceid)*
...
*Implementation of [Commit](../interfaces/types.commit.md).[version](../interfaces/types.commit.md#version)*

## Methods

###  addReceiver

▸ **addReceiver**(`receiver`: [CommitReceiver](commitreceiver.md)): *void*

*Implementation of [Commit](../interfaces/types.commit.md)*
...
------ | ------ | ------ |
`receiver` | [CommitReceiver](commitreceiver.md) | Instance of `CommitReceiver`.  |
...
▸ **getReceiver**(`appId`: string): *[CommitReceiver](commitreceiver.md) | undefined*
...
**Returns:** *[CommitReceiver](commitreceiver.md) | undefined*

Instance of `CommitReceiver`, else `undefined`.
