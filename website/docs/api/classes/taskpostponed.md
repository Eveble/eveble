...
* [metadata](taskpostponed.md#optional-metadata)
...
* [timestamp](taskpostponed.md#optional-timestamp)
...
* [hasCorrelationId](taskpostponed.md#hascorrelationid)
...
\+ **new TaskPostponed**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[TaskPostponed](taskpostponed.md)› & object): *[TaskPostponed](taskpostponed.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[TaskPostponed](taskpostponed.md)› & object | Properties matching generic `T` with `sourceId` as `Guid|string` and optional `version` as `number`.  |
