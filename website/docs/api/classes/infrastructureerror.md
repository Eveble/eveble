---
id: "infrastructureerror"
title: "InfrastructureError"
sidebar_label: "InfrastructureError"
---
...
## Hierarchy
  ...
  ↳ [SerializableError](serializableerror.md)

* SerializableError

  ↳ **InfrastructureError**

  ↳ [CommitConcurrencyError](commitconcurrencyerror.md)

  ↳ [EventsNotFoundError](eventsnotfounderror.md)

  ↳ [AddingCommitFailedError](addingcommitfailederror.md)

  ↳ [UpdatingCommitError](updatingcommiterror.md)

  ↳ [AddingSnapshotError](addingsnapshoterror.md)

  ↳ [UpdatingSnapshotError](updatingsnapshoterror.md)

  ↳ [StorageNotFoundError](storagenotfounderror.md)

  ↳ [RouterError](routererror.md)

  ↳ [SnapshotterError](snapshottererror.md)

  ↳ [UndefinedSnapshotterError](undefinedsnapshottererror.md)

  ↳ [ProjectionRebuildingError](projectionrebuildingerror.md)

  ↳ [ClientError](clienterror.md)

  ↳ [SchedulerError](schedulererror.md)
...
* [constructor](infrastructureerror.md#constructor)

### Properties

* [code](infrastructureerror.md#optional-code)
* [message](infrastructureerror.md#message)
* [name](infrastructureerror.md#name)
* [schemaVersion](infrastructureerror.md#optional-schemaversion)
* [stack](infrastructureerror.md#optional-stack)

### Methods

* [equals](infrastructureerror.md#equals)
* [fillErrorProps](infrastructureerror.md#fillerrorprops)
* [getActions](infrastructureerror.md#getactions)
* [getHook](infrastructureerror.md#gethook)
* [getHookOrThrow](infrastructureerror.md#gethookorthrow)
* [getHooks](infrastructureerror.md#gethooks)
* [getLegacyTransformer](infrastructureerror.md#getlegacytransformer)
* [getLegacyTransformers](infrastructureerror.md#getlegacytransformers)
* [getPropTypes](infrastructureerror.md#getproptypes)
* [getPropertyInitializers](infrastructureerror.md#getpropertyinitializers)
* [getSchemaVersion](infrastructureerror.md#getschemaversion)
* [getTypeName](infrastructureerror.md#gettypename)
* [hasAction](infrastructureerror.md#hasaction)
* [hasHook](infrastructureerror.md#hashook)
* [hasLegacyTransformer](infrastructureerror.md#haslegacytransformer)
* [overrideHook](infrastructureerror.md#overridehook)
* [overrideLegacyTransformer](infrastructureerror.md#overridelegacytransformer)
* [registerHook](infrastructureerror.md#registerhook)
* [registerLegacyTransformer](infrastructureerror.md#registerlegacytransformer)
* [removeHook](infrastructureerror.md#removehook)
* [toJSONValue](infrastructureerror.md#tojsonvalue)
* [toPlainObject](infrastructureerror.md#toplainobject)
* [toString](infrastructureerror.md#tostring)
* [transformLegacyProps](infrastructureerror.md#transformlegacyprops)
* [typeName](infrastructureerror.md#typename)
* [validateProps](infrastructureerror.md#validateprops)
* [getPropTypes](infrastructureerror.md#static-getproptypes)
* [getPropertyInitializers](infrastructureerror.md#static-getpropertyinitializers)
* [getTypeName](infrastructureerror.md#static-gettypename)
* [toString](infrastructureerror.md#static-tostring)
* [typeName](infrastructureerror.md#static-typename)

## Constructors

###  constructor

\+ **new InfrastructureError**(`propsOrMessage?`: [Props](../modules/types.md#props) | string): *[InfrastructureError](infrastructureerror.md)*
...
**Returns:** *[InfrastructureError](infrastructureerror.md)*
