...
* [constructor](quittask.md#constructor)

### Properties

* [id](quittask.md#id)
* [metadata](quittask.md#optional-metadata)
* [schemaVersion](quittask.md#optional-schemaversion)
* [targetId](quittask.md#targetid)
* [timestamp](quittask.md#optional-timestamp)

### Methods

* [assignMetadata](quittask.md#assignmetadata)
* [equals](quittask.md#equals)
* [getActions](quittask.md#getactions)
* [getAssignment](quittask.md#getassignment)
* [getCorrelationId](quittask.md#getcorrelationid)
* [getHook](quittask.md#gethook)
* [getHookOrThrow](quittask.md#gethookorthrow)
* [getHooks](quittask.md#gethooks)
* [getId](quittask.md#getid)
* [getLegacyTransformer](quittask.md#getlegacytransformer)
* [getLegacyTransformers](quittask.md#getlegacytransformers)
* [getMetadata](quittask.md#getmetadata)
* [getPropTypes](quittask.md#getproptypes)
* [getPropertyInitializers](quittask.md#getpropertyinitializers)
* [getSchemaVersion](quittask.md#getschemaversion)
* [getTimestamp](quittask.md#gettimestamp)
* [getTypeName](quittask.md#gettypename)
* [hasAction](quittask.md#hasaction)
* [hasCorrelationId](quittask.md#hascorrelationid)
* [hasHook](quittask.md#hashook)
* [hasLegacyTransformer](quittask.md#haslegacytransformer)
* [hasMetadata](quittask.md#hasmetadata)
* [in](quittask.md#in)
* [isDeliverable](quittask.md#isdeliverable)
* [isScheduled](quittask.md#isscheduled)
* [overrideHook](quittask.md#overridehook)
* [overrideLegacyTransformer](quittask.md#overridelegacytransformer)
* [processSerializableList](quittask.md#processserializablelist)
* [registerHook](quittask.md#registerhook)
* [registerLegacyTransformer](quittask.md#registerlegacytransformer)
* [removeHook](quittask.md#removehook)
* [schedule](quittask.md#schedule)
* [setCorrelationId](quittask.md#setcorrelationid)
* [toJSONValue](quittask.md#tojsonvalue)
* [toPlainObject](quittask.md#toplainobject)
* [toString](quittask.md#tostring)
* [transformLegacyProps](quittask.md#transformlegacyprops)
* [typeName](quittask.md#typename)
* [validateProps](quittask.md#validateprops)
* [disableSerializableLists](quittask.md#static-disableserializablelists)
* [enableSerializableLists](quittask.md#static-enableserializablelists)
* [from](quittask.md#static-from)
* [getPropTypes](quittask.md#static-getproptypes)
* [getPropertyInitializers](quittask.md#static-getpropertyinitializers)
* [getTypeName](quittask.md#static-gettypename)
* [toString](quittask.md#static-tostring)
* [typeName](quittask.md#static-typename)

## Constructors

###  constructor

\+ **new QuitTask**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[QuitTask](quittask.md)› & object): *[QuitTask](quittask.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[QuitTask](quittask.md)› & object | Properties matching generic `T` with `targetId` as `Guid|string`.  |

**Returns:** *[QuitTask](quittask.md)*
