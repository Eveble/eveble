...
title: "EmployeeTerminated"
sidebar_label: "EmployeeTerminated"
---
...
* [constructor](employeeterminated.md#constructor)

### Properties

* [firstName](employeeterminated.md#firstname)
* [lastName](employeeterminated.md#lastname)
* [metadata](employeeterminated.md#optional-metadata)
* [points](employeeterminated.md#points)
* [schemaVersion](employeeterminated.md#optional-schemaversion)
* [sourceId](employeeterminated.md#sourceid)
* [taskListsIds](employeeterminated.md#tasklistsids)
* [timestamp](employeeterminated.md#optional-timestamp)
* [version](employeeterminated.md#optional-version)

### Methods

* [assignMetadata](employeeterminated.md#assignmetadata)
* [equals](employeeterminated.md#equals)
* [getActions](employeeterminated.md#getactions)
* [getCorrelationId](employeeterminated.md#getcorrelationid)
* [getHook](employeeterminated.md#gethook)
* [getHookOrThrow](employeeterminated.md#gethookorthrow)
* [getHooks](employeeterminated.md#gethooks)
* [getId](employeeterminated.md#getid)
* [getLegacyTransformer](employeeterminated.md#getlegacytransformer)
* [getLegacyTransformers](employeeterminated.md#getlegacytransformers)
* [getMetadata](employeeterminated.md#getmetadata)
* [getPropTypes](employeeterminated.md#getproptypes)
* [getPropertyInitializers](employeeterminated.md#getpropertyinitializers)
* [getSchemaVersion](employeeterminated.md#getschemaversion)
* [getTimestamp](employeeterminated.md#gettimestamp)
* [getTypeName](employeeterminated.md#gettypename)
* [hasAction](employeeterminated.md#hasaction)
* [hasCorrelationId](employeeterminated.md#hascorrelationid)
* [hasHook](employeeterminated.md#hashook)
* [hasLegacyTransformer](employeeterminated.md#haslegacytransformer)
* [hasMetadata](employeeterminated.md#hasmetadata)
* [in](employeeterminated.md#in)
* [overrideHook](employeeterminated.md#overridehook)
* [overrideLegacyTransformer](employeeterminated.md#overridelegacytransformer)
* [processSerializableList](employeeterminated.md#processserializablelist)
* [registerHook](employeeterminated.md#registerhook)
* [registerLegacyTransformer](employeeterminated.md#registerlegacytransformer)
* [removeHook](employeeterminated.md#removehook)
* [setCorrelationId](employeeterminated.md#setcorrelationid)
* [toJSONValue](employeeterminated.md#tojsonvalue)
* [toPlainObject](employeeterminated.md#toplainobject)
* [toString](employeeterminated.md#tostring)
* [transformLegacyProps](employeeterminated.md#transformlegacyprops)
* [typeName](employeeterminated.md#typename)
* [validateProps](employeeterminated.md#validateprops)
* [disableSerializableLists](employeeterminated.md#static-disableserializablelists)
* [enableSerializableLists](employeeterminated.md#static-enableserializablelists)
* [from](employeeterminated.md#static-from)
* [getPropTypes](employeeterminated.md#static-getproptypes)
* [getPropertyInitializers](employeeterminated.md#static-getpropertyinitializers)
* [getTypeName](employeeterminated.md#static-gettypename)
* [toString](employeeterminated.md#static-tostring)
* [typeName](employeeterminated.md#static-typename)

## Constructors

###  constructor

\+ **new EmployeeTerminated**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[EmployeeTerminated](employeeterminated.md)› & object): *[EmployeeTerminated](employeeterminated.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[EmployeeTerminated](employeeterminated.md)› & object | Properties matching generic `T` with `sourceId` as `Guid|string` and optional `version` as `number`.  |

**Returns:** *[EmployeeTerminated](employeeterminated.md)*
