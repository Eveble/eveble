---
id: "tasklistclosed"
title: "TaskListClosed"
sidebar_label: "TaskListClosed"
---
...
* [constructor](tasklistclosed.md#constructor)

### Properties

* [metadata](tasklistclosed.md#optional-metadata)
* [schemaVersion](tasklistclosed.md#optional-schemaversion)
* [sourceId](tasklistclosed.md#sourceid)
* [tasks](tasklistclosed.md#tasks)
* [timestamp](tasklistclosed.md#optional-timestamp)
* [title](tasklistclosed.md#title)
* [version](tasklistclosed.md#optional-version)

### Methods

* [assignMetadata](tasklistclosed.md#assignmetadata)
* [equals](tasklistclosed.md#equals)
* [getActions](tasklistclosed.md#getactions)
* [getCorrelationId](tasklistclosed.md#getcorrelationid)
* [getHook](tasklistclosed.md#gethook)
* [getHookOrThrow](tasklistclosed.md#gethookorthrow)
* [getHooks](tasklistclosed.md#gethooks)
* [getId](tasklistclosed.md#getid)
* [getLegacyTransformer](tasklistclosed.md#getlegacytransformer)
* [getLegacyTransformers](tasklistclosed.md#getlegacytransformers)
* [getMetadata](tasklistclosed.md#getmetadata)
* [getPropTypes](tasklistclosed.md#getproptypes)
* [getPropertyInitializers](tasklistclosed.md#getpropertyinitializers)
* [getSchemaVersion](tasklistclosed.md#getschemaversion)
* [getTimestamp](tasklistclosed.md#gettimestamp)
* [getTypeName](tasklistclosed.md#gettypename)
* [hasAction](tasklistclosed.md#hasaction)
* [hasCorrelationId](tasklistclosed.md#hascorrelationid)
* [hasHook](tasklistclosed.md#hashook)
* [hasLegacyTransformer](tasklistclosed.md#haslegacytransformer)
* [hasMetadata](tasklistclosed.md#hasmetadata)
* [in](tasklistclosed.md#in)
* [overrideHook](tasklistclosed.md#overridehook)
* [overrideLegacyTransformer](tasklistclosed.md#overridelegacytransformer)
* [processSerializableList](tasklistclosed.md#processserializablelist)
* [registerHook](tasklistclosed.md#registerhook)
* [registerLegacyTransformer](tasklistclosed.md#registerlegacytransformer)
* [removeHook](tasklistclosed.md#removehook)
* [setCorrelationId](tasklistclosed.md#setcorrelationid)
* [toJSONValue](tasklistclosed.md#tojsonvalue)
* [toPlainObject](tasklistclosed.md#toplainobject)
* [toString](tasklistclosed.md#tostring)
* [transformLegacyProps](tasklistclosed.md#transformlegacyprops)
* [typeName](tasklistclosed.md#typename)
* [validateProps](tasklistclosed.md#validateprops)
* [disableSerializableLists](tasklistclosed.md#static-disableserializablelists)
* [enableSerializableLists](tasklistclosed.md#static-enableserializablelists)
* [from](tasklistclosed.md#static-from)
* [getPropTypes](tasklistclosed.md#static-getproptypes)
* [getPropertyInitializers](tasklistclosed.md#static-getpropertyinitializers)
* [getTypeName](tasklistclosed.md#static-gettypename)
* [toString](tasklistclosed.md#static-tostring)
* [typeName](tasklistclosed.md#static-typename)

## Constructors

###  constructor

\+ **new TaskListClosed**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[TaskListClosed](tasklistclosed.md)› & object): *[TaskListClosed](tasklistclosed.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[TaskListClosed](tasklistclosed.md)› & object | Properties matching generic `T` with `sourceId` as `Guid|string` and optional `version` as `number`.  |

**Returns:** *[TaskListClosed](tasklistclosed.md)*
