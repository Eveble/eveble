---
id: "cancelingemploymentfailed"
title: "CancelingEmploymentFailed"
sidebar_label: "CancelingEmploymentFailed"
---
...
* Event‹[CancelingEmploymentFailed](cancelingemploymentfailed.md)›
...
* [constructor](cancelingemploymentfailed.md#constructor)

### Properties

* [employeeId](cancelingemploymentfailed.md#employeeid)
* [exception](cancelingemploymentfailed.md#exception)
* [metadata](cancelingemploymentfailed.md#optional-metadata)
* [schemaVersion](cancelingemploymentfailed.md#optional-schemaversion)
* [sourceId](cancelingemploymentfailed.md#sourceid)
* [timestamp](cancelingemploymentfailed.md#optional-timestamp)
* [version](cancelingemploymentfailed.md#optional-version)

### Methods

* [assignMetadata](cancelingemploymentfailed.md#assignmetadata)
* [equals](cancelingemploymentfailed.md#equals)
* [getActions](cancelingemploymentfailed.md#getactions)
* [getCorrelationId](cancelingemploymentfailed.md#getcorrelationid)
* [getHook](cancelingemploymentfailed.md#gethook)
* [getHookOrThrow](cancelingemploymentfailed.md#gethookorthrow)
* [getHooks](cancelingemploymentfailed.md#gethooks)
* [getId](cancelingemploymentfailed.md#getid)
* [getLegacyTransformer](cancelingemploymentfailed.md#getlegacytransformer)
* [getLegacyTransformers](cancelingemploymentfailed.md#getlegacytransformers)
* [getMetadata](cancelingemploymentfailed.md#getmetadata)
* [getPropTypes](cancelingemploymentfailed.md#getproptypes)
* [getPropertyInitializers](cancelingemploymentfailed.md#getpropertyinitializers)
* [getSchemaVersion](cancelingemploymentfailed.md#getschemaversion)
* [getTimestamp](cancelingemploymentfailed.md#gettimestamp)
* [getTypeName](cancelingemploymentfailed.md#gettypename)
* [hasAction](cancelingemploymentfailed.md#hasaction)
* [hasCorrelationId](cancelingemploymentfailed.md#hascorrelationid)
* [hasHook](cancelingemploymentfailed.md#hashook)
* [hasLegacyTransformer](cancelingemploymentfailed.md#haslegacytransformer)
* [hasMetadata](cancelingemploymentfailed.md#hasmetadata)
* [in](cancelingemploymentfailed.md#in)
* [overrideHook](cancelingemploymentfailed.md#overridehook)
* [overrideLegacyTransformer](cancelingemploymentfailed.md#overridelegacytransformer)
* [processSerializableList](cancelingemploymentfailed.md#processserializablelist)
* [registerHook](cancelingemploymentfailed.md#registerhook)
* [registerLegacyTransformer](cancelingemploymentfailed.md#registerlegacytransformer)
* [removeHook](cancelingemploymentfailed.md#removehook)
* [setCorrelationId](cancelingemploymentfailed.md#setcorrelationid)
* [toJSONValue](cancelingemploymentfailed.md#tojsonvalue)
* [toPlainObject](cancelingemploymentfailed.md#toplainobject)
* [toString](cancelingemploymentfailed.md#tostring)
* [transformLegacyProps](cancelingemploymentfailed.md#transformlegacyprops)
* [typeName](cancelingemploymentfailed.md#typename)
* [validateProps](cancelingemploymentfailed.md#validateprops)
* [disableSerializableLists](cancelingemploymentfailed.md#static-disableserializablelists)
* [enableSerializableLists](cancelingemploymentfailed.md#static-enableserializablelists)
* [from](cancelingemploymentfailed.md#static-from)
* [getPropTypes](cancelingemploymentfailed.md#static-getproptypes)
* [getPropertyInitializers](cancelingemploymentfailed.md#static-getpropertyinitializers)
* [getTypeName](cancelingemploymentfailed.md#static-gettypename)
* [toString](cancelingemploymentfailed.md#static-tostring)
* [typeName](cancelingemploymentfailed.md#static-typename)

## Constructors

###  constructor

\+ **new CancelingEmploymentFailed**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[CancelingEmploymentFailed](cancelingemploymentfailed.md)› & object): *[CancelingEmploymentFailed](cancelingemploymentfailed.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[CancelingEmploymentFailed](cancelingemploymentfailed.md)› & object | Properties matching generic `T` with `sourceId` as `Guid|string` and optional `version` as `number`.  |

**Returns:** *[CancelingEmploymentFailed](cancelingemploymentfailed.md)*
