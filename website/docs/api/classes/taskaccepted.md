...
* [constructor](taskaccepted.md#constructor)

### Properties

* [employeeId](taskaccepted.md#optional-employeeid)
* [metadata](taskaccepted.md#optional-metadata)
* [schemaVersion](taskaccepted.md#optional-schemaversion)
* [sourceId](taskaccepted.md#sourceid)
* [task](taskaccepted.md#task)
* [timestamp](taskaccepted.md#optional-timestamp)
* [version](taskaccepted.md#optional-version)

### Methods

* [assignMetadata](taskaccepted.md#assignmetadata)
* [equals](taskaccepted.md#equals)
* [getActions](taskaccepted.md#getactions)
* [getCorrelationId](taskaccepted.md#getcorrelationid)
* [getHook](taskaccepted.md#gethook)
* [getHookOrThrow](taskaccepted.md#gethookorthrow)
* [getHooks](taskaccepted.md#gethooks)
* [getId](taskaccepted.md#getid)
* [getLegacyTransformer](taskaccepted.md#getlegacytransformer)
* [getLegacyTransformers](taskaccepted.md#getlegacytransformers)
* [getMetadata](taskaccepted.md#getmetadata)
* [getPropTypes](taskaccepted.md#getproptypes)
* [getPropertyInitializers](taskaccepted.md#getpropertyinitializers)
* [getSchemaVersion](taskaccepted.md#getschemaversion)
* [getTimestamp](taskaccepted.md#gettimestamp)
* [getTypeName](taskaccepted.md#gettypename)
* [hasAction](taskaccepted.md#hasaction)
* [hasCorrelationId](taskaccepted.md#hascorrelationid)
* [hasHook](taskaccepted.md#hashook)
* [hasLegacyTransformer](taskaccepted.md#haslegacytransformer)
* [hasMetadata](taskaccepted.md#hasmetadata)
* [in](taskaccepted.md#in)
* [overrideHook](taskaccepted.md#overridehook)
* [overrideLegacyTransformer](taskaccepted.md#overridelegacytransformer)
* [processSerializableList](taskaccepted.md#processserializablelist)
* [registerHook](taskaccepted.md#registerhook)
* [registerLegacyTransformer](taskaccepted.md#registerlegacytransformer)
* [removeHook](taskaccepted.md#removehook)
* [setCorrelationId](taskaccepted.md#setcorrelationid)
* [toJSONValue](taskaccepted.md#tojsonvalue)
* [toPlainObject](taskaccepted.md#toplainobject)
* [toString](taskaccepted.md#tostring)
* [transformLegacyProps](taskaccepted.md#transformlegacyprops)
* [typeName](taskaccepted.md#typename)
* [validateProps](taskaccepted.md#validateprops)
* [disableSerializableLists](taskaccepted.md#static-disableserializablelists)
* [enableSerializableLists](taskaccepted.md#static-enableserializablelists)
* [from](taskaccepted.md#static-from)
* [getPropTypes](taskaccepted.md#static-getproptypes)
* [getPropertyInitializers](taskaccepted.md#static-getpropertyinitializers)
* [getTypeName](taskaccepted.md#static-gettypename)
* [toString](taskaccepted.md#static-tostring)
* [typeName](taskaccepted.md#static-typename)

## Constructors

###  constructor

\+ **new TaskAccepted**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[TaskAccepted](taskaccepted.md)› & object): *[TaskAccepted](taskaccepted.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[TaskAccepted](taskaccepted.md)› & object | Properties matching generic `T` with `sourceId` as `Guid|string` and optional `version` as `number`.  |

**Returns:** *[TaskAccepted](taskaccepted.md)*
