...
* [constructor](taskdeclined.md#constructor)

### Properties

* [employeeId](taskdeclined.md#optional-employeeid)
* [metadata](taskdeclined.md#optional-metadata)
* [reason](taskdeclined.md#reason)
* [schemaVersion](taskdeclined.md#optional-schemaversion)
* [sourceId](taskdeclined.md#sourceid)
* [task](taskdeclined.md#task)
* [timestamp](taskdeclined.md#optional-timestamp)
* [version](taskdeclined.md#optional-version)

### Methods

* [assignMetadata](taskdeclined.md#assignmetadata)
* [equals](taskdeclined.md#equals)
* [getActions](taskdeclined.md#getactions)
* [getCorrelationId](taskdeclined.md#getcorrelationid)
* [getHook](taskdeclined.md#gethook)
* [getHookOrThrow](taskdeclined.md#gethookorthrow)
* [getHooks](taskdeclined.md#gethooks)
* [getId](taskdeclined.md#getid)
* [getLegacyTransformer](taskdeclined.md#getlegacytransformer)
* [getLegacyTransformers](taskdeclined.md#getlegacytransformers)
* [getMetadata](taskdeclined.md#getmetadata)
* [getPropTypes](taskdeclined.md#getproptypes)
* [getPropertyInitializers](taskdeclined.md#getpropertyinitializers)
* [getSchemaVersion](taskdeclined.md#getschemaversion)
* [getTimestamp](taskdeclined.md#gettimestamp)
* [getTypeName](taskdeclined.md#gettypename)
* [hasAction](taskdeclined.md#hasaction)
* [hasCorrelationId](taskdeclined.md#hascorrelationid)
* [hasHook](taskdeclined.md#hashook)
* [hasLegacyTransformer](taskdeclined.md#haslegacytransformer)
* [hasMetadata](taskdeclined.md#hasmetadata)
* [in](taskdeclined.md#in)
* [overrideHook](taskdeclined.md#overridehook)
* [overrideLegacyTransformer](taskdeclined.md#overridelegacytransformer)
* [processSerializableList](taskdeclined.md#processserializablelist)
* [registerHook](taskdeclined.md#registerhook)
* [registerLegacyTransformer](taskdeclined.md#registerlegacytransformer)
* [removeHook](taskdeclined.md#removehook)
* [setCorrelationId](taskdeclined.md#setcorrelationid)
* [toJSONValue](taskdeclined.md#tojsonvalue)
* [toPlainObject](taskdeclined.md#toplainobject)
* [toString](taskdeclined.md#tostring)
* [transformLegacyProps](taskdeclined.md#transformlegacyprops)
* [typeName](taskdeclined.md#typename)
* [validateProps](taskdeclined.md#validateprops)
* [disableSerializableLists](taskdeclined.md#static-disableserializablelists)
* [enableSerializableLists](taskdeclined.md#static-enableserializablelists)
* [from](taskdeclined.md#static-from)
* [getPropTypes](taskdeclined.md#static-getproptypes)
* [getPropertyInitializers](taskdeclined.md#static-getpropertyinitializers)
* [getTypeName](taskdeclined.md#static-gettypename)
* [toString](taskdeclined.md#static-tostring)
* [typeName](taskdeclined.md#static-typename)

## Constructors

###  constructor

\+ **new TaskDeclined**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[TaskDeclined](taskdeclined.md)› & object): *[TaskDeclined](taskdeclined.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[TaskDeclined](taskdeclined.md)› & object | Properties matching generic `T` with `sourceId` as `Guid|string` and optional `version` as `number`.  |

**Returns:** *[TaskDeclined](taskdeclined.md)*
