---
id: "createtasklist"
title: "CreateTaskList"
sidebar_label: "CreateTaskList"
---
...
* [constructor](createtasklist.md#constructor)

### Properties

* [metadata](createtasklist.md#optional-metadata)
* [schemaVersion](createtasklist.md#optional-schemaversion)
* [targetId](createtasklist.md#targetid)
* [timestamp](createtasklist.md#optional-timestamp)
* [title](createtasklist.md#title)

### Methods

* [assignMetadata](createtasklist.md#assignmetadata)
* [equals](createtasklist.md#equals)
* [getActions](createtasklist.md#getactions)
* [getAssignment](createtasklist.md#getassignment)
* [getCorrelationId](createtasklist.md#getcorrelationid)
* [getHook](createtasklist.md#gethook)
* [getHookOrThrow](createtasklist.md#gethookorthrow)
* [getHooks](createtasklist.md#gethooks)
* [getId](createtasklist.md#getid)
* [getLegacyTransformer](createtasklist.md#getlegacytransformer)
* [getLegacyTransformers](createtasklist.md#getlegacytransformers)
* [getMetadata](createtasklist.md#getmetadata)
* [getPropTypes](createtasklist.md#getproptypes)
* [getPropertyInitializers](createtasklist.md#getpropertyinitializers)
* [getSchemaVersion](createtasklist.md#getschemaversion)
* [getTimestamp](createtasklist.md#gettimestamp)
* [getTypeName](createtasklist.md#gettypename)
* [hasAction](createtasklist.md#hasaction)
* [hasCorrelationId](createtasklist.md#hascorrelationid)
* [hasHook](createtasklist.md#hashook)
* [hasLegacyTransformer](createtasklist.md#haslegacytransformer)
* [hasMetadata](createtasklist.md#hasmetadata)
* [in](createtasklist.md#in)
* [isDeliverable](createtasklist.md#isdeliverable)
* [isScheduled](createtasklist.md#isscheduled)
* [overrideHook](createtasklist.md#overridehook)
* [overrideLegacyTransformer](createtasklist.md#overridelegacytransformer)
* [processSerializableList](createtasklist.md#processserializablelist)
* [registerHook](createtasklist.md#registerhook)
* [registerLegacyTransformer](createtasklist.md#registerlegacytransformer)
* [removeHook](createtasklist.md#removehook)
* [schedule](createtasklist.md#schedule)
* [setCorrelationId](createtasklist.md#setcorrelationid)
* [toJSONValue](createtasklist.md#tojsonvalue)
* [toPlainObject](createtasklist.md#toplainobject)
* [toString](createtasklist.md#tostring)
* [transformLegacyProps](createtasklist.md#transformlegacyprops)
* [typeName](createtasklist.md#typename)
* [validateProps](createtasklist.md#validateprops)
* [disableSerializableLists](createtasklist.md#static-disableserializablelists)
* [enableSerializableLists](createtasklist.md#static-enableserializablelists)
* [from](createtasklist.md#static-from)
* [getPropTypes](createtasklist.md#static-getproptypes)
* [getPropertyInitializers](createtasklist.md#static-getpropertyinitializers)
* [getTypeName](createtasklist.md#static-gettypename)
* [toString](createtasklist.md#static-tostring)
* [typeName](createtasklist.md#static-typename)

## Constructors

###  constructor

\+ **new CreateTaskList**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[CreateTaskList](createtasklist.md)› & object): *[CreateTaskList](createtasklist.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[CreateTaskList](createtasklist.md)› & object | Properties matching generic `T` with `targetId` as `Guid|string`.  |

**Returns:** *[CreateTaskList](createtasklist.md)*
