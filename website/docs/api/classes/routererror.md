...
* InfrastructureError
  ...
  ↳ [MissingEventSourceableError](missingeventsourceableerror.md)

  ↳ [MissingInitializingMessageError](missinginitializingmessageerror.md)

  ↳ [CannotRouteMessageError](cannotroutemessageerror.md)

  ↳ [UnresolvableIdentifierFromMessageError](unresolvableidentifierfrommessageerror.md)
...
* [code](routererror.md#optional-code)
* [message](routererror.md#message)
* [name](routererror.md#name)
* [schemaVersion](routererror.md#optional-schemaversion)
* [stack](routererror.md#optional-stack)

### Methods

* [equals](routererror.md#equals)
* [fillErrorProps](routererror.md#fillerrorprops)
* [getActions](routererror.md#getactions)
* [getHook](routererror.md#gethook)
* [getHookOrThrow](routererror.md#gethookorthrow)
* [getHooks](routererror.md#gethooks)
* [getLegacyTransformer](routererror.md#getlegacytransformer)
* [getLegacyTransformers](routererror.md#getlegacytransformers)
* [getPropTypes](routererror.md#getproptypes)
* [getPropertyInitializers](routererror.md#getpropertyinitializers)
* [getSchemaVersion](routererror.md#getschemaversion)
* [getTypeName](routererror.md#gettypename)
* [hasAction](routererror.md#hasaction)
* [hasHook](routererror.md#hashook)
* [hasLegacyTransformer](routererror.md#haslegacytransformer)
* [overrideHook](routererror.md#overridehook)
* [overrideLegacyTransformer](routererror.md#overridelegacytransformer)
* [registerHook](routererror.md#registerhook)
* [registerLegacyTransformer](routererror.md#registerlegacytransformer)
* [removeHook](routererror.md#removehook)
* [toJSONValue](routererror.md#tojsonvalue)
* [toPlainObject](routererror.md#toplainobject)
* [toString](routererror.md#tostring)
* [transformLegacyProps](routererror.md#transformlegacyprops)
* [typeName](routererror.md#typename)
* [validateProps](routererror.md#validateprops)
* [getPropTypes](routererror.md#static-getproptypes)
* [getPropertyInitializers](routererror.md#static-getpropertyinitializers)
* [getTypeName](routererror.md#static-gettypename)
* [toString](routererror.md#static-tostring)
* [typeName](routererror.md#static-typename)

## Constructors

###  constructor

\+ **new RouterError**(`propsOrMessage?`: [Props](../modules/types.md#props) | string): *[RouterError](routererror.md)*
...
**Returns:** *[RouterError](routererror.md)*
