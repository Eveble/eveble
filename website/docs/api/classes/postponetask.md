...
* [constructor](postponetask.md#constructor)

### Properties

* [id](postponetask.md#id)
* [metadata](postponetask.md#optional-metadata)
* [schemaVersion](postponetask.md#optional-schemaversion)
* [targetId](postponetask.md#targetid)
* [tillAt](postponetask.md#tillat)
* [timestamp](postponetask.md#optional-timestamp)

### Methods

* [assignMetadata](postponetask.md#assignmetadata)
* [equals](postponetask.md#equals)
* [getActions](postponetask.md#getactions)
* [getAssignment](postponetask.md#getassignment)
* [getCorrelationId](postponetask.md#getcorrelationid)
* [getHook](postponetask.md#gethook)
* [getHookOrThrow](postponetask.md#gethookorthrow)
* [getHooks](postponetask.md#gethooks)
* [getId](postponetask.md#getid)
* [getLegacyTransformer](postponetask.md#getlegacytransformer)
* [getLegacyTransformers](postponetask.md#getlegacytransformers)
* [getMetadata](postponetask.md#getmetadata)
* [getPropTypes](postponetask.md#getproptypes)
* [getPropertyInitializers](postponetask.md#getpropertyinitializers)
* [getSchemaVersion](postponetask.md#getschemaversion)
* [getTimestamp](postponetask.md#gettimestamp)
* [getTypeName](postponetask.md#gettypename)
* [hasAction](postponetask.md#hasaction)
* [hasCorrelationId](postponetask.md#hascorrelationid)
* [hasHook](postponetask.md#hashook)
* [hasLegacyTransformer](postponetask.md#haslegacytransformer)
* [hasMetadata](postponetask.md#hasmetadata)
* [in](postponetask.md#in)
* [isDeliverable](postponetask.md#isdeliverable)
* [isScheduled](postponetask.md#isscheduled)
* [overrideHook](postponetask.md#overridehook)
* [overrideLegacyTransformer](postponetask.md#overridelegacytransformer)
* [processSerializableList](postponetask.md#processserializablelist)
* [registerHook](postponetask.md#registerhook)
* [registerLegacyTransformer](postponetask.md#registerlegacytransformer)
* [removeHook](postponetask.md#removehook)
* [schedule](postponetask.md#schedule)
* [setCorrelationId](postponetask.md#setcorrelationid)
* [toJSONValue](postponetask.md#tojsonvalue)
* [toPlainObject](postponetask.md#toplainobject)
* [toString](postponetask.md#tostring)
* [transformLegacyProps](postponetask.md#transformlegacyprops)
* [typeName](postponetask.md#typename)
* [validateProps](postponetask.md#validateprops)
* [disableSerializableLists](postponetask.md#static-disableserializablelists)
* [enableSerializableLists](postponetask.md#static-enableserializablelists)
* [from](postponetask.md#static-from)
* [getPropTypes](postponetask.md#static-getproptypes)
* [getPropertyInitializers](postponetask.md#static-getpropertyinitializers)
* [getTypeName](postponetask.md#static-gettypename)
* [toString](postponetask.md#static-tostring)
* [typeName](postponetask.md#static-typename)

## Constructors

###  constructor

\+ **new PostponeTask**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[PostponeTask](postponetask.md)› & object): *[PostponeTask](postponetask.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[PostponeTask](postponetask.md)› & object | Properties matching generic `T` with `targetId` as `Guid|string`.  |

**Returns:** *[PostponeTask](postponetask.md)*
