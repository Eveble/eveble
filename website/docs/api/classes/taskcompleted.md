...
* [constructor](taskcompleted.md#constructor)

### Properties

* [employeeId](taskcompleted.md#optional-employeeid)
* [metadata](taskcompleted.md#optional-metadata)
* [schemaVersion](taskcompleted.md#optional-schemaversion)
* [sourceId](taskcompleted.md#sourceid)
* [task](taskcompleted.md#task)
* [timestamp](taskcompleted.md#optional-timestamp)
* [version](taskcompleted.md#optional-version)

### Methods

* [assignMetadata](taskcompleted.md#assignmetadata)
* [equals](taskcompleted.md#equals)
* [getActions](taskcompleted.md#getactions)
* [getCorrelationId](taskcompleted.md#getcorrelationid)
* [getHook](taskcompleted.md#gethook)
* [getHookOrThrow](taskcompleted.md#gethookorthrow)
* [getHooks](taskcompleted.md#gethooks)
* [getId](taskcompleted.md#getid)
* [getLegacyTransformer](taskcompleted.md#getlegacytransformer)
* [getLegacyTransformers](taskcompleted.md#getlegacytransformers)
* [getMetadata](taskcompleted.md#getmetadata)
* [getPropTypes](taskcompleted.md#getproptypes)
* [getPropertyInitializers](taskcompleted.md#getpropertyinitializers)
* [getSchemaVersion](taskcompleted.md#getschemaversion)
* [getTimestamp](taskcompleted.md#gettimestamp)
* [getTypeName](taskcompleted.md#gettypename)
* [hasAction](taskcompleted.md#hasaction)
* [hasCorrelationId](taskcompleted.md#hascorrelationid)
* [hasHook](taskcompleted.md#hashook)
* [hasLegacyTransformer](taskcompleted.md#haslegacytransformer)
* [hasMetadata](taskcompleted.md#hasmetadata)
* [in](taskcompleted.md#in)
* [overrideHook](taskcompleted.md#overridehook)
* [overrideLegacyTransformer](taskcompleted.md#overridelegacytransformer)
* [processSerializableList](taskcompleted.md#processserializablelist)
* [registerHook](taskcompleted.md#registerhook)
* [registerLegacyTransformer](taskcompleted.md#registerlegacytransformer)
* [removeHook](taskcompleted.md#removehook)
* [setCorrelationId](taskcompleted.md#setcorrelationid)
* [toJSONValue](taskcompleted.md#tojsonvalue)
* [toPlainObject](taskcompleted.md#toplainobject)
* [toString](taskcompleted.md#tostring)
* [transformLegacyProps](taskcompleted.md#transformlegacyprops)
* [typeName](taskcompleted.md#typename)
* [validateProps](taskcompleted.md#validateprops)
* [disableSerializableLists](taskcompleted.md#static-disableserializablelists)
* [enableSerializableLists](taskcompleted.md#static-enableserializablelists)
* [from](taskcompleted.md#static-from)
* [getPropTypes](taskcompleted.md#static-getproptypes)
* [getPropertyInitializers](taskcompleted.md#static-getpropertyinitializers)
* [getTypeName](taskcompleted.md#static-gettypename)
* [toString](taskcompleted.md#static-tostring)
* [typeName](taskcompleted.md#static-typename)

## Constructors

###  constructor

\+ **new TaskCompleted**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[TaskCompleted](taskcompleted.md)› & object): *[TaskCompleted](taskcompleted.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[TaskCompleted](taskcompleted.md)› & object | Properties matching generic `T` with `sourceId` as `Guid|string` and optional `version` as `number`.  |

**Returns:** *[TaskCompleted](taskcompleted.md)*
