---
id: "assigntasklist"
title: "AssignTaskList"
sidebar_label: "AssignTaskList"
---
...
* [constructor](assigntasklist.md#constructor)

### Properties

* [employeeId](assigntasklist.md#employeeid)
* [metadata](assigntasklist.md#optional-metadata)
* [schemaVersion](assigntasklist.md#optional-schemaversion)
* [targetId](assigntasklist.md#targetid)
* [timestamp](assigntasklist.md#optional-timestamp)

### Methods

* [assignMetadata](assigntasklist.md#assignmetadata)
* [equals](assigntasklist.md#equals)
* [getActions](assigntasklist.md#getactions)
* [getAssignment](assigntasklist.md#getassignment)
* [getCorrelationId](assigntasklist.md#getcorrelationid)
* [getHook](assigntasklist.md#gethook)
* [getHookOrThrow](assigntasklist.md#gethookorthrow)
* [getHooks](assigntasklist.md#gethooks)
* [getId](assigntasklist.md#getid)
* [getLegacyTransformer](assigntasklist.md#getlegacytransformer)
* [getLegacyTransformers](assigntasklist.md#getlegacytransformers)
* [getMetadata](assigntasklist.md#getmetadata)
* [getPropTypes](assigntasklist.md#getproptypes)
* [getPropertyInitializers](assigntasklist.md#getpropertyinitializers)
* [getSchemaVersion](assigntasklist.md#getschemaversion)
* [getTimestamp](assigntasklist.md#gettimestamp)
* [getTypeName](assigntasklist.md#gettypename)
* [hasAction](assigntasklist.md#hasaction)
* [hasCorrelationId](assigntasklist.md#hascorrelationid)
* [hasHook](assigntasklist.md#hashook)
* [hasLegacyTransformer](assigntasklist.md#haslegacytransformer)
* [hasMetadata](assigntasklist.md#hasmetadata)
* [in](assigntasklist.md#in)
* [isDeliverable](assigntasklist.md#isdeliverable)
* [isScheduled](assigntasklist.md#isscheduled)
* [overrideHook](assigntasklist.md#overridehook)
* [overrideLegacyTransformer](assigntasklist.md#overridelegacytransformer)
* [processSerializableList](assigntasklist.md#processserializablelist)
* [registerHook](assigntasklist.md#registerhook)
* [registerLegacyTransformer](assigntasklist.md#registerlegacytransformer)
* [removeHook](assigntasklist.md#removehook)
* [schedule](assigntasklist.md#schedule)
* [setCorrelationId](assigntasklist.md#setcorrelationid)
* [toJSONValue](assigntasklist.md#tojsonvalue)
* [toPlainObject](assigntasklist.md#toplainobject)
* [toString](assigntasklist.md#tostring)
* [transformLegacyProps](assigntasklist.md#transformlegacyprops)
* [typeName](assigntasklist.md#typename)
* [validateProps](assigntasklist.md#validateprops)
* [disableSerializableLists](assigntasklist.md#static-disableserializablelists)
* [enableSerializableLists](assigntasklist.md#static-enableserializablelists)
* [from](assigntasklist.md#static-from)
* [getPropTypes](assigntasklist.md#static-getproptypes)
* [getPropertyInitializers](assigntasklist.md#static-getpropertyinitializers)
* [getTypeName](assigntasklist.md#static-gettypename)
* [toString](assigntasklist.md#static-tostring)
* [typeName](assigntasklist.md#static-typename)

## Constructors

###  constructor

\+ **new AssignTaskList**(`props`: [ConstructorType](../modules/types.md#constructortype)‹[AssignTaskList](assigntasklist.md)› & object): *[AssignTaskList](assigntasklist.md)*
...
------ | ------ | ------ |
`props` | [ConstructorType](../modules/types.md#constructortype)‹[AssignTaskList](assigntasklist.md)› & object | Properties matching generic `T` with `targetId` as `Guid|string`.  |

**Returns:** *[AssignTaskList](assigntasklist.md)*
