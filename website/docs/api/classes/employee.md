...
* [[COMMANDS_KEY]](employee.md#[commands_key])
* [[EVENTS_KEY]](employee.md#[events_key])
* [firstName](employee.md#firstname)
* [id](employee.md#id)
* [lastName](employee.md#lastname)
* [metadata](employee.md#optional-metadata)
* [points](employee.md#points)
* [schemaVersion](employee.md#optional-schemaversion)
* [state](employee.md#state)
* [status](employee.md#status)
* [taskListsIds](employee.md#tasklistsids)
* [version](employee.md#version)

### Accessors

* [ableTo](employee.md#ableto)
* [can](employee.md#can)
* [ensure](employee.md#ensure)
* [is](employee.md#is)

### Methods

* [AssignTaskListToEmployee](employee.md#assigntasklisttoemployee)
* [CreateEmployee](employee.md#createemployee)
* [EmployeeCreated](employee.md#employeecreated)
* [EmployeeProductivityEstimated](employee.md#employeeproductivityestimated)
* [EmployeeTerminated](employee.md#employeeterminated)
* [EstimateEmployeeProductivity](employee.md#estimateemployeeproductivity)
* [TaskListAssignedToEmployee](employee.md#tasklistassignedtoemployee)
* [TerminateEmployee](employee.md#terminateemployee)
...
* [getActions](employee.md#getactions)
* [getCommands](employee.md#getcommands)
* [getEvents](employee.md#getevents)
* [getHandleableTypes](employee.md#gethandleabletypes)
* [getHandled](employee.md#gethandled)
* [getHandledCommands](employee.md#gethandledcommands)
* [getHandledEvents](employee.md#gethandledevents)
* [getHandledMessages](employee.md#gethandledmessages)
* [getHandledTypes](employee.md#gethandledtypes)
* [getHandledTypesNames](employee.md#gethandledtypesnames)
* [getHandler](employee.md#gethandler)
* [getHandlerOrThrow](employee.md#gethandlerorthrow)
* [getHandlers](employee.md#gethandlers)
* [getHook](employee.md#gethook)
* [getHookOrThrow](employee.md#gethookorthrow)
* [getHooks](employee.md#gethooks)
* [getId](employee.md#getid)
* [getLegacyTransformer](employee.md#getlegacytransformer)
* [getLegacyTransformers](employee.md#getlegacytransformers)
* [getPropTypes](employee.md#getproptypes)
* [getPropertyInitializers](employee.md#getpropertyinitializers)
* [getSchemaVersion](employee.md#getschemaversion)
* [getSelectableStates](employee.md#getselectablestates)
* [getSelectableStatuses](employee.md#getselectablestatuses)
* [getState](employee.md#getstate)
* [getStatus](employee.md#getstatus)
* [getTypeByHandler](employee.md#gettypebyhandler)
* [getTypeName](employee.md#gettypename)
* [getVersion](employee.md#getversion)
* [handle](employee.md#handle)
* [handles](employee.md#handles)
* [hasAction](employee.md#hasaction)
* [hasHandler](employee.md#hashandler)
* [hasHook](employee.md#hashook)
* [hasLegacyTransformer](employee.md#haslegacytransformer)
* [hasState](employee.md#hasstate)
* [hasStatus](employee.md#hasstatus)
* [in](employee.md#in)
* [incrementVersion](employee.md#incrementversion)
* [initialize](employee.md#initialize)
* [isHandleabe](employee.md#ishandleabe)
* [isInOneOfStates](employee.md#isinoneofstates)
* [isInOneOfStatuses](employee.md#isinoneofstatuses)
* [isInState](employee.md#isinstate)
* [isInStatus](employee.md#isinstatus)
* [isStateSaved](employee.md#isstatesaved)
* [on](employee.md#on)
...
* [registerHook](employee.md#registerhook)
* [registerLegacyTransformer](employee.md#registerlegacytransformer)
* [removeHandler](employee.md#removehandler)
* [removeHook](employee.md#removehook)
* [replay](employee.md#replay)
* [replayHistory](employee.md#replayhistory)
* [schedule](employee.md#schedule)
* [setHandleableTypes](employee.md#sethandleabletypes)
* [setState](employee.md#setstate)
* [setStatus](employee.md#setstatus)
* [setVersion](employee.md#setversion)
* [subscribes](employee.md#subscribes)
* [toJSONValue](employee.md#tojsonvalue)
* [toPlainObject](employee.md#toplainobject)
* [toString](employee.md#tostring)
* [transformLegacyProps](employee.md#transformlegacyprops)
* [typeName](employee.md#typename)
* [unschedule](employee.md#unschedule)
* [validateProps](employee.md#validateprops)
* [validateState](employee.md#validatestate)
* [validateStatus](employee.md#validatestatus)
* [disableSerializableLists](employee.md#static-disableserializablelists)
* [enableSerializableLists](employee.md#static-enableserializablelists)
* [from](employee.md#static-from)
* [getPropTypes](employee.md#static-getproptypes)
* [getPropertyInitializers](employee.md#static-getpropertyinitializers)
* [getTypeName](employee.md#static-gettypename)
* [resolveInitializingMessage](employee.md#static-resolveinitializingmessage)
* [resolveRoutedCommands](employee.md#static-resolveroutedcommands)
* [resolveRoutedEvents](employee.md#static-resolveroutedevents)
* [resolveRoutedMessages](employee.md#static-resolveroutedmessages)
* [toString](employee.md#static-tostring)
* [typeName](employee.md#static-typename)

### Object literals

* [STATES](employee.md#static-states)
...
▸ **AssignTaskListToEmployee**(`command`: [AssignTaskListToEmployee](assigntasklisttoemployee.md)): *void*

**Parameters:**

Name | Type |
------ | ------ |
`command` | [AssignTaskListToEmployee](assigntasklisttoemployee.md) |
...
▸ **CreateEmployee**(`command`: [CreateEmployee](createemployee.md)): *void*
...
▸ **EmployeeCreated**(`event`: [EmployeeCreated](employeecreated.md)): *void*

**Parameters:**

Name | Type |
------ | ------ |
`event` | [EmployeeCreated](employeecreated.md) |
...
▸ **EmployeeProductivityEstimated**(`event`: [EmployeeProductivityEstimated](employeeproductivityestimated.md)): *void*

**Parameters:**

Name | Type |
------ | ------ |
`event` | [EmployeeProductivityEstimated](employeeproductivityestimated.md) |
...
▸ **EmployeeTerminated**(`_event`: [EmployeeTerminated](employeeterminated.md)): *void*

**Parameters:**

Name | Type |
------ | ------ |
`_event` | [EmployeeTerminated](employeeterminated.md) |
...
▸ **EstimateEmployeeProductivity**(`command`: [EstimateEmployeeProductivity](estimateemployeeproductivity.md)): *void*

**Parameters:**

Name | Type |
------ | ------ |
`command` | [EstimateEmployeeProductivity](estimateemployeeproductivity.md) |
...
▸ **TaskListAssignedToEmployee**(`event`: [TaskListAssignedToEmployee](tasklistassignedtoemployee.md)): *void*

**Parameters:**

Name | Type |
------ | ------ |
`event` | [TaskListAssignedToEmployee](tasklistassignedtoemployee.md) |
